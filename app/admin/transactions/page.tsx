...
return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="flex flex-col items-center justify-between mb-6 sm:flex-row sm:items-start">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 w-full sm:w-auto">
                <div className="flex gap-2">
                    <button
                        ...
                        disabled={exporting}
                        className="flex items-center gap-1.5 border border-gray-200 text-gray-700 px-3 py-2 rounded-lg text-sm hover:bg-gray-50 transition-colors disabled:opacity-50 w-full sm:w-auto"
                    >
        ...
        {/* Filters */}
        <div className="bg-white rounded-xl border border-gray-100 p-4 mb-4 flex flex-col sm:flex-row sm:flex-wrap sm:gap-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2 w-full">
                <label className="text-sm text-gray-500 mb-2 sm:mb-0">Тип</label>
                <select
                    value={type}
                    onChange={(e) => setType(e.target.value)}
                    className="px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white text-gray-700 w-full sm:w-auto"
                >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2 w-full">
                <div className="flex flex-col">
                    <label className="text-sm text-gray-500 mb-1">С</label>
                    <input
                        type="date"
                        value={from}
                        onChange={(e) => setFrom(e.target.value)}
                        className="px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white w-full sm:w-auto"
                    />
                </div>
                <div className="flex flex-col">
                    <label className="text-sm text-gray-500 mb-1">По</label>
                    <input
                        type="date"
                        value={to}
            ...
            {(type || from || to) && (
                <button
                    ...
                    className="mt-4 sm:mt-0 text-sm text-gray-400 hover:text-gray-700 px-2"
                >
                    Сбросить
                </button>
            )}
