...
TODO:
- Убери отправку ссылки на Telegram-бота для верификации номера. Вместо этого сделай генерацию QR-кода на мониторе: при сканировании код должен открывать чат с моим Telegram-ботом и автоматически запрашивать номер телефона для подтверждения клиента. Сотрудник больше не отправляет ссылку вручную.
