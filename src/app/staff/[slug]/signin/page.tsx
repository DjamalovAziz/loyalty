  ...
  return (
    <main className="mx-auto max-w-sm px-4 py-16">
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-4">
        ...
        <input className="rounded border border-border border-border bg-card px-3 py-2 text-foreground placeholder:text-muted" type="password" placeholder={t("staffSignin.pin")} value={pin}
